...
namespace HRExpert.Organization.Data.EntityFramework.SqlServer.Repository
{
    ...
    public class DepartmentRepository : ExtCore.Data.EntityFramework.SqlServer.RepositoryBase<Department>, IDepartmentRepository
    {
        ...
        /// <param name="Id"></param>
        /// <returns></returns>
        public IEnumerable<Department> AllByOrganization(int Id)
        {
            return this.dbSet             
                .Include(x=>x.Organization)   
        ...
        public Department ByOrganizationAndKey(int organizationid, int departmentid)
        {
            return this.dbSet
                .Include(x=>x.Organization)
        ...
        /// <param name="Id"></param>
        /// <returns></returns>
        public virtual Department Read(int Id)
        {
            return this.dbSet
                .Include(x=>x.Organization)
                .Where(x => x.Id == Id)
        ...
        /// <param name="Id"></param>
        /// <returns></returns>
        public virtual Department ReadWithChildsAndParents(int Id)
        {
            return this.dbSet
                .Include(x=>x.Organization)                
                .Include(x=>x.Childs)
