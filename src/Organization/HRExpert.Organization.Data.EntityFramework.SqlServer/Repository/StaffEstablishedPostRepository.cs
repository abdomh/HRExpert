...
namespace HRExpert.Organization.Data.EntityFramework.SqlServer.Repository
{
    ...
    /// </summary>
    public class StaffEstablishedPostRepository : Base.RepositoryWithPermissions<StaffEstablishedPost>, Abstractions.IStaffEstablishedPostRepository
    {       
        ...
        /// <returns></returns>
        public List<StaffEstablishedPost> GetByDepartmentId(int DepartmentId)
        {            
            return Query()
        ...
        /// <returns></returns>
        public StaffEstablishedPost Read(int DepartmentId, int PositionId)
        {
            return Query()
                .Include(x => x.Department).ThenInclude(x=>x.Organization)
                .Include(x => x.Position)
        ...
        /// <param name="DepartmentId"></param>
        /// <param name="PositionId"></param>
        public virtual void Delete(int DepartmentId, int PositionId)
        {
